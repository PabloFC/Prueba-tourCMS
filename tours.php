	...
	<div id="page" class="site">
			...
			<div class="container">
				<div class="row">
					<div id="container">
						...
						<?php
						// tour_name, tour_url, summary, thumbnail_image, duration,
											...
											<div id="c-49-d" class="carousel slide" data-interval="false">
												<div class="carousel-inner">
													<div class="carousel-item active">
														<img class="d-block w-100" src="<?php echo $thumbnail_image; ?>" alt="tour_image">
													</div>
												</div>
											</div>
										</div>
		...
		<footer id="colophon" class="site-footer navbar-light" role="contentinfo">
			<div class="container pt-3 pb-3">
				<div class="site-info">
					&copy; 2023 <a href="https://wordpress.tourcms.com">TourCMS Demo</a> <span class="sep"> | </span>
